...
<b>Made With ❤ BY  <a href=https://t.me/SD_BOT_SUPPORT>𝗦𝗗 𝗕𝗢𝗧 𝗨𝗣𝗗𝗔𝗧𝗘𝗦</a> </b>
"""
...
ABOUT_TXT = """
<b>🤖 ʙᴏᴛ ɴᴀᴍᴇ : [{name}](t.me/{username})

👨‍💻 𝖣ᴇᴠᴇʟᴏᴘᴇʀ : sᴜɴᴇᴇsʜ ᴅᴇᴇᴢᴜᴢᴢᴀ

📝 ʟᴀɴɢᴜᴀɢᴇ : <a href=https://www.python.org/>ᴘʏᴛʜᴏɴ3</a>

📚 ғʀᴀᴍᴇᴡᴏʀᴋ : ᴘʏʀᴏɢʀᴀᴍ

📡 𝖧ᴏsᴛᴇᴅ ᴏɴ : <a href=https://t.me/SD_Botzz>sᴅ ʙᴏᴛs</a>

👥 sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ : <a href=https://t.me/Mallu_Movie_Hub_Group>ᴄɪɴᴇᴍᴀ ᴄɪᴛʏ ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ</a>

📢 𝖴ᴘᴅᴀᴛᴇs ᴄʜᴀɴɴᴇʟ : <a href=https://t.me/SD_BOT_SUPPORT>ᴄʟɪᴄᴋ ʜᴇʀᴇ</a> 

☘️ ᴅᴀᴛᴀʙᴀsᴇ : ᴍᴏɴɢᴏ ᴅʙ </b>
"""
...
FILE_CAPTION_TXT = """<b>✏️ғɪʟᴇ ɴᴀᴍᴇ : </b> <code>{file_name}</code>
<b>╭──── • ❰[Movie Group](https://t.me/Mallu_Movie_Hub_Group)❱ • ───➤
┣ ▫️[Update Channel](https://t.me/SD_Botzz) | [File Channel](https://t.me/+ZiDeeN9yubk5NDhl)
╰──────── • ◆ • ──────➤</b>
<b>⚙️ғɪʟᴇ sɪᴢᴇ : {size}</b>"""

SPELLCHECK_TXT = """<b>Hey {mention}
ᴘʟᴇᴀsᴇ ᴄʜᴇᴄᴋ ʏᴏᴜʀ sᴘᴇʟʟɪɴɢ\nനിങ്ങൾക്ക് ആവശ്യമുള്ള മൂവിയുടെ പേര് മൂവി ഇറങ്ങിയ വർഷം എഴുതി അയക്കുക, മൂവിയുടെ പേര് Googlil ഉള്ളത് പോലെ ആയിരിക്കണം..!!</b>
"""
